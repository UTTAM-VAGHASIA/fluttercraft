...
def start_command():
    ...
    while True:
        ...
        if command.lower() == "exit" or command.lower() == "quit" or command.lower() == "q":
            ...
            console.print("[yellow]In a future update, this would start the Flutter app creation wizard![/]")
        elif command.lower().startswith("flutter"):
            console.print("[yellow]In a future update, this would handle Flutter commands![/]")
        elif command.lower().startswith("fvm"):
            console.print("[yellow]In a future update, this would handle FVM commands![/]")
        else:
