...
def prompt_user_with_border(completer, history):
    ...
    def get_completions_text():
        ...
        visible_completions = current_completions[scroll_offset[0]:scroll_offset[0] + VISIBLE_ITEMS]
    ...
    root_container = HSplit([
        ...
        LayoutWindow(
            ...
            height=Dimension(min=6, max=6),  # Fixed height for menu (5 items + 1 scroll indicator)
