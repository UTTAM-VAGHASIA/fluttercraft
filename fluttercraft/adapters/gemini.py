...
class GeminiAdapter(CLIAdapter):
    """Adapter for Gemini CLI (``gemini`` binary)."""
    ...
    def send(
        ...
        """Run ``gemini -p <message>`` and stream output line by line."""
        session.messages.append(
        ...
        try:
            ...
            on_chunk("[error] gemini binary not found")
